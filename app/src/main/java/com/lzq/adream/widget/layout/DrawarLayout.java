...
public class DrawarLayout extends RelativeLayout {
    ...
    public DrawarLayout(Context context) {
        this(context, null);
    }

    public DrawarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawarLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    ViewDragHelper.Callback mCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top,
            ...
            if (changedView == mMainContent) {
              ...
              mMainContent.layout(0, 0, newLeft+mWidth, 0 + mHeight);
            }
